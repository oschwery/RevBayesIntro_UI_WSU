...
2. Install [FigTree](https://github.com/rambaut/figtree/releases) and [Tracer](https://github.com/beast-dev/tracer/releases/tag/v1.7.2)
or
3. Install the R package [RevGadgets](https://cran.r-project.org/web/packages/RevGadgets/index.html), which contains a lot of post-processing tools and ways to make nicer plots.
4. Have whatever editor ready you like to use to write code in (you could even use RStudio, if you use VScode, there's a RevBayes [syntax](https://marketplace.visualstudio.com/items?itemName=Benjamin-So.revSyntax) highlighter available).
